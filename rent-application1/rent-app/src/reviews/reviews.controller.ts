...
export class ReviewsController {
  ...
  @Delete(':id') // Assuming this endpoint is for deleting reviews
  async deleteReviewById(
    @Param('id') reviewId: string, // Review ID expected in the route parameter
    @GetUser() user: User // Retrieve the authenticated user
  ): Promise<void> {
